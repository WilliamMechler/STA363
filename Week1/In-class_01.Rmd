...
Next, let's see how *United Kingdom of Great Britain and Northern Ireland* and *France*'s voting record changed over the years on each of the issues.
...
un.compare <- un_votes %>%
  filter(country %in% c("United Kingdom of Great Britain and Northern Ireland", "France")) %>%
  inner_join(un_roll_calls, by = "rcid") %>%
...
**I picked United Kingdom of Great Britain and Northern Ireland and France. Because they are both in Europe and are a part of the EU, however the UK is planning to leave the EU. I wanted to see if their differences in the EU come across in their UN voting habits.**
...
**Not really we see that they both seem to vote in the same manner for most of the votes. But the interesting part is under the Economic Development graph were they seem to disagree. This was expected because one of the many reasons for the UK to leave the EU has to do with the market of Europe to majorly oversimplify. **
